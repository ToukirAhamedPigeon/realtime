  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className='shad-dialog'>
            <DialogHeader>
            <DialogTitle className=''>Manage who can view this project?</DialogTitle>
            ...
            <div className='my-2 space-y-2'>
                <div className='flex flex-col'>
                    {collaborators.map((collaborator)=>(
                        <Collaborator key={collaborator.id} roomId={roomId} creatorId={creatorId} email={collaborator.email} collaborator={collaborator} user={user?.info as User} />
                    ))}
                </div>
